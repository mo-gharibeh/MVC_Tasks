...
namespace School.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,DateOfBirth,Address")] StudentDetails studentDetails)
        {
            ...
            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "FirstName", studentDetails.StudentId);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,DateOfBirth,Address")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
