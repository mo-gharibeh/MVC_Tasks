...
namespace Task5.Controllers
{
    public class UserTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Emaile,Password,Image")] UserTable userTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Emaile,Password,Image")] UserTable userTable)
        {
            if (ModelState.IsValid)
            {
